...
```
    ...
    ┌ Info: fmi2Unzip(...): Successfully unzipped 29 files at `/tmp/fmijl_9P2tEU/SpringFrictionPendulum1D`.
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/S8pFT/src/FMI2_ext.jl:75
    ┌ Info: fmi2Load(...): FMU resources location is `file:////tmp/fmijl_9P2tEU/SpringFrictionPendulum1D/resources`
...
```
    ...
    ┌ Info: fmi2Unzip(...): Successfully unzipped 29 files at `/tmp/fmijl_aNttjX/SpringPendulum1D`.
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/S8pFT/src/FMI2_ext.jl:75
    ┌ Info: fmi2Load(...): FMU resources location is `file:////tmp/fmijl_aNttjX/SpringPendulum1D/resources`
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/S8pFT/src/FMI2_ext.jl:190
    ┌ Info: fmi2Load(...): FMU supports both CS and ME, using CS as default if nothing specified.
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/S8pFT/src/FMI2_ext.jl:193
...
In the following functions for pre-processing and post-processing are defined. The function `preProc` is normalized the input values to a value range between $[0;1]$. 
...
function preProc(data)
    global minData, factor
    maxData = maximum(data)
    minData = minimum(data)
    
    factor = (maxNorm - minNorm) / (maxData - minData)
    
    (data .- minData) .* ((maxNorm - minNorm) / (maxData - minData)) .+ minNorm    
end 
```
...
```
    ...
    ┌ Info:    Loss [1] for horizon 5 : 0.00737   
    │         Avg displacement in data: 0.08585
    └ @ Main In[12]:9
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_2.svg)
    ...
    ┌ Info:    Loss [21] for horizon 7 : 0.00458   
    │         Avg displacement in data: 0.06768
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_5.svg)
    ...
    ┌ Info:    Loss [41] for horizon 9 : 0.00567   
    │         Avg displacement in data: 0.07533
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_8.svg)
    ...
    ┌ Info:    Loss [61] for horizon 11 : 0.00034   
    │         Avg displacement in data: 0.01831
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_11.svg)
    ...
    ┌ Info:    Loss [81] for horizon 13 : 0.00089   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_14.svg)
    ...
    ┌ Info:    Loss [101] for horizon 15 : 0.00349   
    │         Avg displacement in data: 0.05907
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_17.svg)
    ...
    ┌ Info:    Loss [121] for horizon 17 : 0.00633   
    │         Avg displacement in data: 0.07953
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_20.svg)
    ...
    ┌ Info:    Loss [141] for horizon 19 : 0.00363   
    │         Avg displacement in data: 0.06023
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_23.svg)
    ...
    ┌ Info:    Loss [161] for horizon 21 : 0.00203   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_26.svg)
    ...
    ┌ Info:    Loss [181] for horizon 23 : 0.00105   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_29.svg)
    ...
    ┌ Info:    Loss [201] for horizon 25 : 0.0005   
    │         Avg displacement in data: 0.02243
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_32.svg)
    ...
    ┌ Info:    Loss [221] for horizon 27 : 0.00058   
    │         Avg displacement in data: 0.02405
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_35.svg)
    ...
    ┌ Info:    Loss [241] for horizon 29 : 0.00081   
    │         Avg displacement in data: 0.02847
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_38.svg)
    ...
    ┌ Info:    Loss [261] for horizon 31 : 0.00074   
    │         Avg displacement in data: 0.02726
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_41.svg)
    ...
    ┌ Info:    Loss [281] for horizon 33 : 0.00067   
    │         Avg displacement in data: 0.02587
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_44.svg)
    ...
    ┌ Info:    Loss [301] for horizon 35 : 0.00086   
    │         Avg displacement in data: 0.02927
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_47.svg)
    ...
    ┌ Info:    Loss [321] for horizon 37 : 0.0011   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_50.svg)
    ...
    ┌ Info:    Loss [341] for horizon 39 : 0.00122   
    │         Avg displacement in data: 0.035
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_53.svg)
    ...
    ┌ Info:    Loss [361] for horizon 41 : 0.00119   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_56.svg)
    ...
    ┌ Info:    Loss [381] for horizon 43 : 0.00111   
    │         Avg displacement in data: 0.03338
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_59.svg)
    ...
    ┌ Info:    Loss [401] for horizon 45 : 0.00162   
    │         Avg displacement in data: 0.04029
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_62.svg)
    ...
    ┌ Info:    Loss [421] for horizon 47 : 0.0026   
    │         Avg displacement in data: 0.05097
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_65.svg)
    ...
    ┌ Info:    Loss [441] for horizon 49 : 0.00286   
    │         Avg displacement in data: 0.05347
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_68.svg)
    ...
    ┌ Info:    Loss [461] for horizon 51 : 0.00309   
    │         Avg displacement in data: 0.05559
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_71.svg)
    ...
    ┌ Info:    Loss [481] for horizon 51 : 0.00303   
    │         Avg displacement in data: 0.05505
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_74.svg)
    ...
    ┌ Info:    Loss [501] for horizon 51 : 0.00286   
    │         Avg displacement in data: 0.05351
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_77.svg)
    ...
    ┌ Info:    Loss [521] for horizon 51 : 0.0027   
    │         Avg displacement in data: 0.05201
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_80.svg)
    ...
    ┌ Info:    Loss [541] for horizon 51 : 0.00257   
    │         Avg displacement in data: 0.05073
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_83.svg)
    ...
    ┌ Info:    Loss [561] for horizon 51 : 0.00243   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_86.svg)
    ...
    ┌ Info:    Loss [581] for horizon 51 : 0.0023   
    │         Avg displacement in data: 0.04793
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_89.svg)
    ...
    ┌ Info:    Loss [601] for horizon 51 : 0.00215   
    │         Avg displacement in data: 0.04638
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_92.svg)
    ...
    ┌ Info:    Loss [621] for horizon 51 : 0.00201   
    │         Avg displacement in data: 0.04479
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_95.svg)
    ...
    ┌ Info:    Loss [641] for horizon 51 : 0.00186   
    │         Avg displacement in data: 0.04316
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_98.svg)
    ...
    ┌ Info:    Loss [661] for horizon 51 : 0.00173   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_101.svg)
    ...
    ┌ Info:    Loss [681] for horizon 51 : 0.0016   
    │         Avg displacement in data: 0.04003
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_104.svg)
    ...
    ┌ Info:    Loss [701] for horizon 51 : 0.00148   
    │         Avg displacement in data: 0.03847
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_107.svg)
    ...
    ┌ Info:    Loss [721] for horizon 51 : 0.00136   
    │         Avg displacement in data: 0.03693
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_110.svg)
    ...
    ┌ Info:    Loss [741] for horizon 51 : 0.00125   
    │         Avg displacement in data: 0.03541
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_113.svg)
    ...
    ┌ Info:    Loss [761] for horizon 51 : 0.00114   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_116.svg)
    ...
    │         Avg displacement in data: 0.03223
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_119.svg)
    ...
    ┌ Info:    Loss [801] for horizon 51 : 0.00093   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_122.svg)
    ...
    ┌ Info:    Loss [821] for horizon 51 : 0.00083   
    │         Avg displacement in data: 0.02877
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_125.svg)
    ...
    ┌ Info:    Loss [841] for horizon 51 : 0.00073   
    │         Avg displacement in data: 0.027
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_128.svg)
    ...
    ┌ Info:    Loss [861] for horizon 51 : 0.00064   
...
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_131.svg)
    ...
    ┌ Info:    Loss [881] for horizon 51 : 0.00055   
    │         Avg displacement in data: 0.02337
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_134.svg)
    ...
    ┌ Info:    Loss [901] for horizon 51 : 0.00046   
    │         Avg displacement in data: 0.02153
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_137.svg)
    ...
    ┌ Info:    Loss [921] for horizon 51 : 0.00039   
    │         Avg displacement in data: 0.01976
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_140.svg)
    ...
    ┌ Info:    Loss [941] for horizon 51 : 0.00032   
    │         Avg displacement in data: 0.01796
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_143.svg)
    ...
    ┌ Info:    Loss [961] for horizon 51 : 0.00026   
    │         Avg displacement in data: 0.01621
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_146.svg)
    ...
    ┌ Info:    Loss [981] for horizon 51 : 0.00021   
    │         Avg displacement in data: 0.01456
    └ @ Main In[12]:9



    
![svg](advanced_hybrid_ME_files/advanced_hybrid_ME_37_149.svg)
